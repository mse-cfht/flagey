...
def create_target_list(p_elg=1., p_lbg=1., p_qso=1., nobs=1):
    ...
    # JS NOTE: The coding below is for a specific RA/Dec range ONLY!
    # Must modify!
    ...
    for i in range(2):
        if i == 0:
            ...
            sel_lbg = sel_lbg & (ra > 167.) & (ra < 169) & (dec < 2.5) & (dec > 0.5)
            sel_elg = sel_elg & (ra > 167.) & (ra < 169) & (dec < 2.5) & (dec > 0.5)
            sel_qso = sel_qso & (ra > 167.) & (ra < 169) & (dec < 2.5) & (dec > 0.5)
            file = 'large'
        else:
            ...
            sel_lbg = sel_lbg & (ra > 167.9) & (ra < 168) & (dec < 1.5) & (dec > 1.3)
            sel_elg = sel_elg & (ra > 167.9) & (ra < 168) & (dec < 1.5) & (dec > 1.3)
            sel_qso = sel_qso & (ra > 167.9) & (ra < 168) & (dec < 1.5) & (dec > 1.3)
            file = 'small'
        ...
        vstack([data_lbg, data_elg, data_qso]).write('TARGETS/cosmo_targets_' + file + '_new-JS.csv',
