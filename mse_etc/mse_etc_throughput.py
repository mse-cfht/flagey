...
def mse_etc_throughput():
    ...
    ascii.write(m1_gem_data, path + 'mse_etc_throughput_m1_gemini.dat', overwrite=True)
    # print values at Lam0 and Lam1 for budget
    ...
    plt.ylim([0.50, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_m1_zecoat.png')
    ...
    pfue_thr_etc = sili_arcoat ** (pfue_sili_nlens * 2) * pbm_arcoat ** (pfue_pb_nlens * 2) *\
                   pfue_trans_sili * pfue_trans_pb * pfue_vign
    # save file for ITC
    pfue_data = Table([lam, pfue_thr_etc], names=['lamA', 'thr'])
    ascii.write(pfue_data, path + 'mse_etc_throughput_pfue.dat', overwrite=True)
    pfhs_data = Table([lam, pfue_obsc], names=['lamA', 'thr'])
    ascii.write(pfhs_data, path + 'mse_etc_throughput_pfhs.dat', overwrite=True)
    ...
    pfue_ws = ascii.read(path + 'mse_etc_throughput_pfue_WS.dat', format= 'csv')
    # print values at Lam1 for budget
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_pfue.png', bbox_inches="tight")
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_fits.png', bbox_inches="tight")
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_specLR.png', bbox_inches="tight")
    # plot and save - MR
    plt.figure(figsize=(10, 5))
    for i in range(3):
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_specMR.png', bbox_inches="tight")
    # plot and save - HR
    plt.figure(figsize=(10, 5))
    for i in range(3):
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_specHR.png', bbox_inches="tight")
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_LR.png', bbox_inches="tight")
    # plot and save - MR
    plt.figure(figsize=(10, 5))
    for i in range(3):
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_MR.png', bbox_inches="tight")
    # plot and save - HR
    plt.figure(figsize=(10, 5))
    for i in range(3):
    ...
    plt.ylim([0.0, 1.05])
    plt.legend()
    plt.savefig(path + 'mse_etc_throughput_HR.png', bbox_inches="tight")
